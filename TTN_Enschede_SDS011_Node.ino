...
//    serialSDS.begin(9600);                               // 
    ...
    DEBUG_PLN("LMIC_setupChannel CFG_eu868");
    ...
    DEBUG_PLN("LMIC_selectSubBand CFG_us915");
    #endif
...
//    display.setFont(ArialMT_Plain_24);
    ...
    display.drawString(0, 20, "TTN Enschede");
    display.drawString(0, 18, "Fijnstof sensor");
    display.display();
#endif
